...
class MG_RRTStar:
    ...
    def set_constraints(self, table_center=(0,-0.9), table_size=(1,1), reachable_length = 1.1, object_size=(0.48, 0.33)):
    ...
    def within_cs(self, state):
        ...
        # print("state: ", state.pos)
        # print("corner_pos: ", corner_pos)
        # print("dist: ", dist)
...
def plan(node_s, node_t, params=None, control_file=None, save_plot=None, repeat=1):
    ...
    for i in range(repeat):
        ...
        rrt_star.set_constraints(**params)
    ...
    for i in range(len(path)):
        print("state: ", path[i].pos, "control: ", path[i].control)
        if i == 0:
